...
import com.withcue.service.http.GraphQLRequestUnmarshaller.{explicitlyAccepts, _}
import com.withcue.service.http.CorsSupport
...
object Server extends App with CorsSupport {
  ...
  val route: Route =
    optionalHeaderValueByName("X-Apollo-Tracing") { tracing ⇒
      path("playground") {
        get {
          getFromResource("assets/graphql-playground.html")
        }
      } ~
      path("graphql") {
        get {
